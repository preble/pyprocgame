...
class ScoreDisplay(Mode):
    ...
    def set_left_players_justify(self, left_players_justify):
        ...
        if left_players_justify == "left":
            self.score_posns = {True: [(0, 0), (128, 0), (0, 11), (128, 11)],
                                False: [(0, -1), (128, -1), (0, 16), (128, 16)]}
        elif left_players_justify == "right":
            self.score_posns = {True: [(75, 0), (128, 0), (75, 11), (128, 11)],
                                False: [(52, -1), (128, -1), (52, 16), (128, 16)]}
        else:
    ...
    def format_score(self, score):
        ...
        if score == 0:
            ...
            return locale.format_string("%d", score, True)
