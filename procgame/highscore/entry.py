from ..dmd import dmd
from ..dmd.font import font_named
from ..dmd.layers import *
    ...
    *left_text* and *right_text* are strings or arrays to be displayed at the
    ...
    def animate_to_index(self, new_index, inc=0):
        ...
        for x in rng:
            ...
            for offset in range(-7, 8):
                ...
                self.letters_font.draw(frame, self.letters[index],
                                       128 / 2 - offset * letter_spread - letter_width / 2 + x, 0)
    ...
    def letter_accept(self):
        ...
        if letter == self.char_back:
            ...
            if self.entered_handler is not None:
